...
- **Global scope**: `/home/narumir/projects/moew/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/narumir/projects/moew/.claude/notes/`)
...
2. Glob `/home/narumir/projects/moew/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/narumir/projects/moew/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/narumir/projects/moew/.claude/notes/` — works in any directory
